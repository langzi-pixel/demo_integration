...
LL_ATON_DECLARE_NAMED_NN_INSTANCE_AND_INTERFACE(yamnet) // Defines NN_Instance_yamnet and NN_Interface_yamnet with network.c info

AI_ALIGNED(32)
static ai_u8 activations_1[0];
AI_ALIGNED(32)
static ai_u8 activations_2[147456];
AI_ALIGNED(32)
...
int main(int argc, char* argv[])
{
  ...
  while(1)
  {
    LL_ATON_RT_Main(&NN_Instance_yamnet);
  }
}
