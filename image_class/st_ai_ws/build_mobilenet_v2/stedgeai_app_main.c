...
LL_ATON_DECLARE_NAMED_NN_INSTANCE_AND_INTERFACE(mobilenet_v2) // Defines NN_Instance_mobilenet_v2 and NN_Interface_mobilenet_v2 with network.c info
...
int main(int argc, char* argv[])
{
  ...
  while(1)
  {
    LL_ATON_RT_Main(&NN_Instance_mobilenet_v2);
  }
}
